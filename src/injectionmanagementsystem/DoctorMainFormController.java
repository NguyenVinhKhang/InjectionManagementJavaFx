...
public class DoctorMainFormController implements Initializable {
    ...
    @FXML
    private TableColumn<AppointmentData, String> appointments_col_vaccineId;
    @FXML
    private TableColumn<AppointmentData, String> appointments_col_vaccineName;
    @FXML
    ...
    @FXML
    private ComboBox<String> appointment_name;

    @FXML
    private ComboBox<String> appointment_productName;
    ...
    @FXML
    private ComboBox<String> appointment_vaccineBrand;

    @FXML
    private ComboBox<Integer> appointment_vaccineID;

    @FXML
    private ComboBox<String> appointment_vaccineType;
...
// NOW, LETS TRY 
    ...
    public void patientRecordBtn() {
        try {
            ...
            stage.setTitle("Injection Management System | Record of Patients");
...
//        CHECK IF THE FIELD(S) ARE EMPTY
        if (appointment_appointmentID.getText().isEmpty()
                || appointment_name.getSelectionModel().getSelectedItem() == null
                ...
                || appointment_vaccineBrand.getSelectionModel().getSelectedItem() == null
                || appointment_vaccineID.getSelectionModel().getSelectedItem() == null
                || appointment_productName.getSelectionModel().getSelectedItem() == null
                || appointment_vaccineType.getSelectionModel().getSelectedItem() == null
            ...
            try {
                ...
                if (result.next()) {
                    ...
                    String insertData = "INSERT INTO appointment (appointment_id, name, patient_id"
                            + ", description,vaccine_id,brand,productName,type"
                            + ", date, status, doctor, specialized, schedule) "
                            + "VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)";
                    prepare = connect.prepareStatement(insertData);

                    prepare.setString(1, appointment_appointmentID.getText());
                    prepare.setString(2, (String) appointment_name.getSelectionModel().getSelectedItem());
                    prepare.setString(3, (String) appointment_patientId.getText());
                    prepare.setString(4, appointment_description.getText());
                    prepare.setString(5, appointment_vaccineID.getSelectionModel().getSelectedItem().toString());
                    prepare.setString(6, (String) appointment_vaccineBrand.getSelectionModel().getSelectedItem());
                    prepare.setString(7, (String) appointment_productName.getSelectionModel().getSelectedItem());
                    prepare.setString(8, (String) appointment_vaccineType.getSelectionModel().getSelectedItem());
    ...
    public void appointmentUpdateBtn() {
        ...
        if (appointment_appointmentID.getText().isEmpty()
            ...
            String updateData = "UPDATE appointment SET name = '"
                    + appointment_name.getSelectionModel().getSelectedItem() + "', patient_id = '"
                    + appointment_patientId.getText() + "', description = '"
                    + appointment_description.getText() + "', vaccine_id = '"
                    + appointment_vaccineID.getSelectionModel().getSelectedItem().toString() + "', brand = '"
                    + appointment_vaccineBrand.getSelectionModel().getSelectedItem() + "', productName = '"
                    + appointment_productName.getSelectionModel().getSelectedItem() + "', type = '"
                    + appointment_vaccineType.getSelectionModel().getSelectedItem() + "', status = '"
    ...
    public void appointmentClearBtn() {
        ...
        appointment_name.getSelectionModel().clearSelection();
        ...
        appointment_vaccineBrand.getSelectionModel().clearSelection();
        appointment_vaccineID.getSelectionModel().clearSelection();
        appointment_productName.getSelectionModel().clearSelection();
        appointment_vaccineType.getSelectionModel().clearSelection();
    }
    ...
    public void appointmentNameData() {

        String sql = "SELECT full_name FROM patient WHERE  doctor = '" + Data.doctor_id + "'";
        ...
        try {
            ...
            appointment_name.setItems(listData);

            appointment_name.getSelectionModel().selectedItemProperty().addListener((observable, oldValue, newValue) -> {
                appointmentIDSet();
            });
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void appointmentIDSet() {
        String sql = "SELECT patient_id FROM patient WHERE full_name='" + appointment_name.getSelectionModel().getSelectedItem() + "'";
        ...
        try {
            ...
            if (result.next()) {
                ...
                appointment_patientId.setText(String.valueOf(patientId));
                appointment_patientId.setDisable(true);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void appointmentType() {
        ...
        try {
            ...
            appointment_vaccineType.setItems(listData);
    ...
    public void appointmentVaccineId() {
        ...
        String sql = "SELECT * FROM vaccine WHERE type = '"
                + appointment_vaccineType.getSelectionModel().getSelectedItem() + "'";
        ...
        try {
            ...
            appointment_vaccineID.setItems(listData);
    ...
    public void appointmentBrand() {
        ...
        String sql = "SELECT * FROM vaccine WHERE vaccine_id = '"
                + appointment_vaccineID.getSelectionModel().getSelectedItem() + "'";
        ...
        try {
            ...
            appointment_vaccineBrand.setItems(listData);
    ...
    public void appointmentProductName() {
        ...
        String sql = "SELECT * FROM vaccine WHERE brand = '"
                + appointment_vaccineBrand.getSelectionModel().getSelectedItem() + "'";
        ...
        try {
            ...
            appointment_productName.setItems(listData);
        } catch (Exception e) {
            e.printStackTrace();
        }
...
//            Long mobileNumber, String description, String  String address,
//            Date date, Date dateModify, Date dateDelete, String status, Date schedule
    ...
    public void appointmentShowData() {
        ...
        appointments_col_vaccineId.setCellValueFactory(new PropertyValueFactory<>("vaccine_id"));
        appointments_col_vaccineName.setCellValueFactory(new PropertyValueFactory<>("productName"));
...
// TO SELECT THE DATA PER ROW IN THE TABLE
    ...
    public void appointmentSelect() {
        ...
        appointment_name.getSelectionModel().select(appData.getName());
//        appointment_patientId.setText("" + appData.getPatientID());
        ...
        appointment_vaccineBrand.getSelectionModel().select(appData.getBrand());
        appointment_vaccineID.getSelectionModel().select(appData.getVaccine_id());
        appointment_productName.getSelectionModel().select(appData.getProductName());
        appointment_vaccineType.getSelectionModel().select(appData.getType());
        Date scheduleDate = appData.getSchedule();
        ...
        appointment_schedule.setValue(LocalDate.of(year, month, day));
    ...
    private String[] specialization = {"Doctot1", "Doctot2", "Doctot3", "Doctot4", "Doctot5"};
